...
def create_bert_model(max_length=150):
    ...
    model.compile(optimizer=tfa.optimizers.RectifiedAdam(learning_rate=2e-5),
                  loss=losses.SparseCategoricalCrossentropy(),
                  metrics=[metrics.SparseCategoricalAccuracy()])

    model.load_weights(filepath='./models/best_kobert_weights_hk.h5')
